...
public class PTFMSDaoImpl implements PTFMSDao {
    ...
    public void registerGps(GpsDTO g) {
        String query = "INSERT INTO GPS (StaffID, VehicleID, StartingLocation, "
                + "StartTime, EndTime, EndingLocation, ScheduledEndTime, Notes)\n" +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
