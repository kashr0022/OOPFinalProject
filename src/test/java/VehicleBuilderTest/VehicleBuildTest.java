 ...
 *  SimpleVehicleFactor, registered in the database using
 *  PTFMSDaoImpl, and then retrieved correctly.
 * This test covers:
 *     Building a  VehicleDTO with valid attribute
...
public class VehicleBuildTest {
    ...
    public void testRegisterVehicleAndCheckTaken() {
        ...
        assertEquals("DB007", fetched.getVehicleNumber());
