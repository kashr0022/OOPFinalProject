...
/**
 * Unit tests for {@link PTFMSDaoImpl}, verifying DAO operations
 * related to user, staff, and reporting functionality.
 * These tests check:
 *     User existence verification
 *     Staff existence verification
 *     Adding staff and user records
 *     Retrieving a user by username
 *     Generating and validating cost reports
 * @author  oussema
 */
public class PTFMSDaoImpTest {
    ...
    /**
     * Verifies that {@link PTFMSDaoImpl#checkUserTaken(UsersDTO)}
    ...
    /**
     * Verifies that {@link PTFMSDaoImpl#checkStaffTaken(StaffDTO)}
     ...
     * via {@link PTFMSDaoImpl#addStaffUser(StaffDTO, UsersDTO)} persists both records.
     */
    @Test
    ...
    /**
     * Verifies that a user added via {@link PTFMSDaoImpl#addStaffUser(StaffDTO, UsersDTO)}
     * can be retrieved correctly using {@link PTFMSDaoImpl#getUserByUsername(String)}.
     */
    @Test
    ...
    /**
     * Verifies that {@link PTFMSDaoImpl#getCostReport()} returns a non-null,
     * non-empty list and that each {@link CostReportDTO} contains valid values.
     */
    @Test
